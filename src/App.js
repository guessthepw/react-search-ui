  ...
  return (
    <SearchProvider config={config}>
      ...
      <Tabs activeTab={{ id: "tab1" }}>
        <Tabs.Tab id="tab1" title="Search1">
          <WithSearch
        ...
        <Tabs.Tab id="tab2" title="Search2">
          <SearchProvider config={config}>
            <WithSearch
              mapContextToProps={({ wasSearched }) => ({ wasSearched })}
            >
        ...
        <Tabs.Tab id="tab3" title="Search3">
          <SearchProvider config={config}>
            <WithSearch
              mapContextToProps={({ wasSearched }) => ({ wasSearched })}
            >
        ...
        <Tabs.Tab id="tab4" title="Search4">
          <SearchProvider config={config}>
            <WithSearch
              mapContextToProps={({ wasSearched }) => ({ wasSearched })}
            >
        ...
        <Tabs.Tab id="tab5" title="Search5">
          <SearchProvider config={config}>
            <WithSearch
              mapContextToProps={({ wasSearched }) => ({ wasSearched })}
            >
        ...
        <Tabs.Tab id="tab6" title="Search6">
          <SearchProvider config={config}>
            <WithSearch
              mapContextToProps={({ wasSearched }) => ({ wasSearched })}
            >
        ...
        <Tabs.Tab id="tab7" title="Search7">
          <SearchProvider config={config}>
            <WithSearch
              mapContextToProps={({ wasSearched }) => ({ wasSearched })}
            >
        ...
        <Tabs.Tab id="tab8" title="Search8">
          <SearchProvider config={config}>
            <WithSearch
              mapContextToProps={({ wasSearched }) => ({ wasSearched })}
            >
        ...
        <Tabs.Tab id="tab9" title="Search9">
          <SearchProvider config={config}>
            <WithSearch
              mapContextToProps={({ wasSearched }) => ({ wasSearched })}
            >
        ...
        <Tabs.Tab id="tab10" title="Search10">
          <SearchProvider config={config}>
            <WithSearch
              mapContextToProps={({ wasSearched }) => ({ wasSearched })}
            >
        ...
        <Tabs.Tab id="tab11" title="Search11">
          <SearchProvider config={config}>
            <WithSearch
              mapContextToProps={({ wasSearched }) => ({ wasSearched })}
            >
